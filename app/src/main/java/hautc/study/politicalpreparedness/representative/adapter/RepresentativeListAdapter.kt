...
import hautc.study.politicalpreparedness.network.models.Channel
import hautc.study.politicalpreparedness.representative.model.Representative
import hautc.study.politicalprepareness.databinding.RepresentativeItemLayoutBinding

class RepresentativeListAdapter : ListAdapter<Representative, RepresentativeListAdapter.RepresentativeViewHolder>(DiffCallback) {
	...
	class RepresentativeViewHolder(val binding: RepresentativeItemLayoutBinding) :
		...
		companion object {
			fun from(parent: ViewGroup): RepresentativeViewHolder {
				...
				val binding = RepresentativeItemLayoutBinding.inflate(layoutInflater, parent, false)
